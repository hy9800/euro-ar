...
export async function generateMetadata({
  ...
  if (!blog) {
    return {
      title: "لا يوجد مدونة متاحة | الدول التدريبية العالمية",
      description: "لا يوجد مدونة متاحة | الدول التدريبية العالمية",
      // robots: {
      //   index: false,
      //   follow: false,
      // },
  ...
  return {
    ...
    openGraph: {
      ...
      authors: ["الدول التدريبية العالمية"],
    ...
    other: {
      ...
      "article:author": "الدول التدريبية العالمية",
    },
  };
}
    ...
    <>
      ...
      <main>
        ...
        <article className="max-w-4xl mx-auto" itemScope itemType="https://schema.org/BlogPosting">
          ...
          <meta itemProp="author" content="الدول التدريبية العالمية" />
          ...
          <section className="bg-white rounded-xl md:p-8 md:shadow-lg" itemProp="articleBody">
            <div
              ...
              prose-blockquote:border-r-4 prose-blockquote:border-blue-600 prose-blockquote:pl-6 prose-blockquote:my-8 prose-blockquote:italic prose-blockquote:text-gray-600 prose-blockquote:bg-blue-50 prose-blockquote:py-4 prose-blockquote:rounded-r-lg
