...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title:
        seo.meta_title ||
        `${course.title} in ${city.title} | الدول التدريبية العالمية`,
      description:
        seo.meta_description ||
        course.description ||
        `دورة تدريبية مهنية: ${course.title} في ${city.title}. قم بتطوير مهاراتك مع يوروكويست إنترناشيونال برنامج مدرب من قبل الخبراء.`,
      keywords:
        seo.meta_keywords ||
        `${course.title}, ${city.title}, دورة تدريبية مهنية, ${
          course.category?.title
        }, الدول التدريبية العالمية, skill development, ${city.title.toLowerCase()} courses`,
    ...
    return {
      title:
        "دورة التدريب | الدول التدريبية العالمية",
      description:
  ...
  return (
    <>
      ...
      <Schema
        ...
        pageTitle={
          seo.meta_title ||
          `${course.title} in ${city.title} | الدول التدريبية العالمية Training`
        }
        pageDescription={
          seo.meta_description ||
          course.description ||
          `Professional training course: ${course.title} in ${city.title}. Enhance your skills with الدول التدريبية العالمية's expert-led program.`
        }
        pageUrl={
          seo.canonical ||
          `${baseUrl}/training-course/${course.slug}/${city.slug}`
