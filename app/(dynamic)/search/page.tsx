...
export async function generateMetadata({
  ...
  let description =
    "Search for professional training courses, categories, and cities at الدول التدريبية العالمية. Find the perfect training program for your career development.";
  ...
  if (searchTerms.length > 0) {
    ...
    title = `Search Results for "${searchQuery}" | الدول التدريبية العالمية`;
    description = `Find professional training courses matching "${searchQuery}" at الدول التدريبية العالمية. Explore expert-led programs designed to enhance your skills and career prospects.`;
  }
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "الدول التدريبية العالمية Training Courses",
          type: "image/jpeg",
        },
      ],
    },
...
export default async function SearchPage({ searchParams }: SearchPageProps) {
  ...
  const searchSchema = {
    ...
    description:
      "Search results for professional training courses at الدول التدريبية العالمية",
    url: `${baseUrl}/search`,
    breadcrumb: {
      "@type": "BreadcrumbList",
      itemListElement: [
  ...
  return (
    <>
      ...
      <Schema
        pageType="search"
        pageTitle="Search Training Courses | الدول التدريبية العالمية"
        pageDescription="Search for professional training courses, categories, and cities at الدول التدريبية العالمية. Find the perfect training program for your career development."
