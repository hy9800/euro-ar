...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return {
      title:
        "Training & Development Blogs | الدول التدريبية العالمية Expert Articles",
      description:
        "Explore الدول التدريبية العالمية's training and development blog, featuring expert articles on leadership, management, human resources, project planning, and career growth to keep professionals updated with the latest industry trends.",
      keywords:
...
export default async function BlogsPage({ searchParams }: BlogsPageProps) {
  ...
  const blogListSchema = blogsData?.blogs?.data
    ? {
        ...
        "@type": "Blog",
        name: "المدونات | الدول التدريبية العالمية",
        description:
          "المدونات | الدول التدريبية العالمية",
        url: `${baseUrl}/blogs`,
        publisher: {
          "@type": "Organization",
  ...
  if (!blogsData || !blogsData.blogs || !blogsData.blogs.data || blogsData.blogs.data.length === 0) {
    return (
      <>
        <Schema
          pageType="blogs"
          pageTitle="المدونات | الدول التدريبية العالمية"
          pageDescription="المدونات | الدول التدريبية العالمية"
          pageUrl={`${baseUrl}/blogs`}
        />
        <HeroBanner
          backgroundImage="/assets/images/hero-blogs.png"
          title="المدونات | الدول التدريبية العالمية"
          description="المدونات | الدول التدريبية العالمية"
        ...
        <Container className="text-center">
          <article className="bg-gray-50 border border-gray-200 rounded-lg p-8">
            ...
            <p className="text-gray-600">
              نحن نعمل على إضافة محتوى المدونات. يرجى التحقق مرة أخرى قريبا!
            </p>
          </article>
        </Container>
      </>
  ...
  return (
    <>
      ...
      <Schema
        pageType="blogs"
        pageTitle="Training & Development Blogs | الدول التدريبية العالمية Expert Articles"
        pageDescription="Explore الدول التدريبية العالمية's training and development blog, featuring expert articles on leadership, management, human resources, project planning, and career growth to keep professionals updated with the latest industry trends."
        pageUrl={`${baseUrl}/blogs`}
      />
      ...
      <header>
        <HeroBanner
          ...
          description="Explore الدول التدريبية العالمية's training and development blog, featuring expert articles on leadership, management, human resources, project planning, and career growth to keep professionals updated with the latest industry trends."
          breadcrumbs={breadcrumbs}
          enableTypewriter={true}
          typewriterSpeed={100}
          typewriterDelay={500}
