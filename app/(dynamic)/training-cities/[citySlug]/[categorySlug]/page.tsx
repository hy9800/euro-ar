...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title: seo.meta_title || `${category.title} Training Courses in ${city.title} | الدول التدريبية العالمية`,
      description: seo.meta_description || `Professional ${category.title} training courses in ${city.title} by الدول التدريبية العالمية. Enhance your skills with our expert-led programs.`,
      keywords: seo.meta_keywords || `${category.title}, ${city.title}, training courses, professional training, الدول التدريبية العالمية, skill development, ${city.title.toLowerCase()} ${category.title.toLowerCase()}`,
  ...
  return (
    <>
      ...
      <Schema
        ...
        pageTitle={
          seo.meta_title ||
          `${category.title} Training Courses in ${city.title} | الدول التدريبية العالمية`
        }
        pageDescription={
          seo.meta_description ||
          `Professional ${category.title} training courses in ${city.title} by الدول التدريبية العالمية. Enhance your skills with our expert-led programs.`
        }
        pageUrl={
