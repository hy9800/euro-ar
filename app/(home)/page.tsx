...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    // Fallback metadata
    return {
      title: "الدول التدريبية العالمية Training | Professional Training Courses & Programs",
      description: "الدول التدريبية العالمية Training provides diverse professional courses in management, HR, IT, finance, and quality. Advance your skills and grow your career with expert programs.",
    ...
    "@graph": [
      {
        ...
        "description": "Founded in 2015 by a team with over 25 years of expertise, الدول التدريبية العالمية has delivered more than 1000 training courses, benefiting over 15,000 participants across diverse sectors in global hubs including Dubai, London, Barcelona, Istanbul, Vienna, Paris, and Geneva.",
        "foundingDate": "2015",
