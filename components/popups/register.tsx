          ...
          <div className="register-right flex-1 p-4 md:p-6 overflow-y-auto rounded-lg max-md:p-3">
            ...
            <form onSubmit={handleSubmit} className="form-inputs flex flex-col gap-6">
              ...
              <div className="form-section mb-6">
                <h2 className="text-[#3E5EC0] text-lg font-semibold mb-2.5">معلومات الشركة</h2>
                <div className="form-grid register-grid grid gap-2 md:grid-cols-3 max-md:grid-cols-1 max-md:gap-3">
                  {/* Company Name */}
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="company_name" className="text-[13px] text-[#333]">اسم الشركة</label>
                    <input
                      type="text"
                      id="company_name"
                      name="company_name"
                  ...
                  {/* City */}
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="city" className="text-[13px] text-[#333]">المدينة</label>
                    <input
                      type="text"
                      id="city"
                      name="city"
                  ...
                  {/* Country */}
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="country" className="text-[13px] text-[#333]">الدولة</label>
                    <input
                      type="text"
                      id="country"
                      name="country"
              ...
              {/* Contact Information */}
              <div className="form-section mb-6">
                <h2 className="text-[#3E5EC0] text-lg font-semibold mb-2.5">معلومات الاتصال</h2>
                <div className="form-grid register-grid grid gap-2 md:grid-cols-4 max-md:grid-cols-1 max-md:gap-3">
                  {/* Full Name */}
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="full_name" className="text-[13px] text-[#333]">الاسم الكامل</label>
                    <input
                      type="text"
                      id="full_name"
                      name="full_name"
                  ...
                  {/* Job Title */}
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="job_title" className="text-[13px] text-[#333]">المسمى الوظيفي</label>
                    <input
                      type="text"
                      id="job_title"
                      name="job_title"
                  ...
                  {/* Email */}
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="email" className="text-[13px] text-[#333]">البريد الإلكتروني</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
              ...
              {/* Responsible Person Information */}
              <div className="form-section mb-6">
                <h2 className="text-[#3E5EC0] text-lg font-semibold mb-2.5">معلومات الشخص المسؤول</h2>
                <div className="form-grid register-grid grid gap-2 md:grid-cols-4 max-md:grid-cols-1 max-md:gap-3">
                  {/* Responsible Name */}
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="responsible_name" className="text-[13px] text-[#333]">اسم الشخص المسؤول</label>
                    <input
                      type="text"
                      id="responsible_name"
                  ...
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="responsible_position" className="text-[13px] text-[#333]">منصب الشخص المسؤول</label>
                    <input
                      type="text"
                      id="responsible_position"
                      name="responsible_position"
                      placeholder="منصب الشخص المسؤول"
                  ...
                  {/* Responsible Email */}
                  <div className="form-group flex flex-col gap-1">
                    <label htmlFor="responsible_email" className="text-[13px] text-[#333]">بريد الشخص المسؤول</label>
                    <input
                      type="email"
                      id="responsible_email"
                      name="responsible_email"
                      placeholder="بريد الشخص المسؤول"
              ...
              <div className="form-submition flex items-center justify-between gap-8 max-md:flex-col-reverse max-md:gap-4">
                ...
                >
                  <span className="btn-text">{registerMutation.isPending ? 'جارِ التسجيل...' : 'تسجيل'}</span>
                  {!registerMutation.isPending && <ChevronLeft className="w-4 h-4 transition-transform duration-500 group-hover:translate-x-0.5" />}
                </button>
