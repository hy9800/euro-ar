...
export default function InquirePopup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccessAlert('تم إرسال الاستفسار بنجاح!', 'شكراً لك على استفسارك! سنتواصل معك قريباً.')
      ...
      showErrorAlert('خطأ!', 'حدث خطأ أثناء إرسال استفسارك. يرجى المحاولة مرة أخرى.')
    }
  }
          ...
          <div className="register-right flex-1 p-4 md:p-6 overflow-y-auto rounded-lg max-md:p-3">
            ...
            <form onSubmit={handleSubmit} className="form-inputs flex flex-col gap-4">
              ...
              <div className="form-grid grid gap-2 md:grid-cols-2 max-md:grid-cols-1 max-md:gap-3">
                ...
                {/* Email */}
                <div className="form-group flex flex-col gap-1">
                  <label htmlFor="inquire_email" className="text-[13px] text-[#333]">البريد الإلكتروني</label>
                  <input
                    type="email"
                    id="inquire_email"
                    name="email"
                ...
                {/* Company */}
                <div className="form-group flex flex-col gap-1">
                  <label htmlFor="inquire_company" className="text-[13px] text-[#333]">الشركة</label>
                  <input
                    type="text"
                    id="inquire_company"
                    name="company"
                ...
                {/* City */}
                <div className="form-group flex flex-col gap-1">
                  <label htmlFor="inquire_city" className="text-[13px] text-[#333]">المدينة</label>
                  <input
                    type="text"
                    id="inquire_city"
                    name="city"
                ...
                {/* Country */}
                <div className="form-group flex flex-col gap-1">
                  <label htmlFor="inquire_country" className="text-[13px] text-[#333]">الدولة</label>
                  <input
                    type="text"
                    id="inquire_country"
                    name="country"
              ...
              <div className="form-group message-group flex flex-col gap-1">
                <label htmlFor="inquire_message" className="text-[13px] text-[#333]">الرسالة</label>
                <textarea
                  id="inquire_message"
                  name="message"
                  placeholder="رسالتك"
